...
class RegexEntityExtractor(EntityExtractor):
    ...
    Fast, pattern-based entity extraction. Less accurate than NER-based
    approaches but provides consistent performance.
    """
    ...
    def extract_entities(self, text: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing the extracted resource, filters, and data
        """
        entities = {
            "resource": None,
            "filters": {},
...
def extract_entities(text: str) -> Dict[str, Any]:
    ...
    This is a convenience function that uses the RegexEntityExtractor singleton.

    Args:
        text: The input text to extract entities from

    Returns:
        Dictionary containing extracted resource, filters, and data
    """
